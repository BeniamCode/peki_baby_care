...
class _MainScreenState extends State<MainScreen> {
  ...
  void _onItemTapped(int index) {
    ...
    PlatformUtils.hapticFeedback(HapticFeedbackType.selection);
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              PlatformUtils.hapticFeedback(HapticFeedbackType.light);
            },
          ),
        ],
      ),
            ...
            GridView.count(
              ...
              children: [
                QuickActionCard(
                  ...
                  color: Colors.orange,
                  onTap: () {
                    PlatformUtils.hapticFeedback(HapticFeedbackType.medium);
                  },
                ),
                QuickActionCard(
                  icon: Icons.bedtime,
...
class FeedingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Feeding Tracker')),
      body: const Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
...
class DiaperPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Diaper Tracker')),
      body: const Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
